...
{
    public partial class lib : UserControl
    {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "select serial_number, lib_name, lib_type,amount,price from libirarian  where lib_name =:name";
            ...
            c.Connection = conn;
            c.CommandText = "select descrip_val from lib_discrip  where lib_serialnum =:id";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cd.Connection = conn;
            cd.CommandText = "select serial_number ,price from libirarian where fo_name = :name";
            ...
            if (dr2.Read())
            {
                ...
                c2.Connection = conn;
                c2.CommandText = "insert into  user_lib values(:id , :serial)";
                ...
                md.Connection = conn;
                md.CommandText = "select serial_number , amount  from libirarian where fo_name = :name";
                ...
                if (dr1.Read())
                {
                    ...
                    c1.Connection = conn;
                    c1.CommandText = "update  libirarian set amount = :neam  where serial_number = :ss";
