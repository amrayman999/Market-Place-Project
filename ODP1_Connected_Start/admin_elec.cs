...
{
    public partial class admin_elec : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "insert into electronic values (:snum,:name,:type,:amount,:price,:ad_pass)";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string cmdstr1 = "select * from electronic";
        ...
        private void admin_elec_Load(object sender, EventArgs e)
        {
