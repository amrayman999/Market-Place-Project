...
namespace ODP1_Connected_Start
{
    public partial class elec : UserControl
    {
        ...
        private void elec_Load(object sender, EventArgs e)
        {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "select serial_number, ele_name, ele_type,amount,price from electronic  where ele_name =:name";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cd.Connection = conn;
            cd.CommandText = "select serial_number ,price from electronic  where ele_name = :name";
            ...
            if (dr2.Read())
            {
                ...
                c2.Connection = conn;
                c2.CommandText = "insert into  user_electronic values(:id , :serial)";
                ...
                md.Connection = conn;
                md.CommandText = "select serial_number , amount  from electronic where ele_name = :name";
                ...
                if (dr1.Read())
                {
                    ...
                    c1.Connection = conn;
                    c1.CommandText = "update  electronic set amount = :neam  where serial_number = :ss";
