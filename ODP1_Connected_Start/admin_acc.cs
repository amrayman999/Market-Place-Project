...
{
    public partial class admin_acc : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "insert into accessory values (:snum,:name,:type,:amount,:price,:ad_pass)";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string cmdstr1 = "select * from accessory";
