...
namespace ODP1_Connected_Start
{
    public partial class toy : UserControl
    {
        ...
        private void toy_Load(object sender, EventArgs e)
        {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "select serial_number, t_name, t_type,amount,price from toy where t_name =:name";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cd.Connection = conn;
            cd.CommandText = "select serial_number ,price from electronic  where t_name = :name";
            ...
            if (dr2.Read())
            {
                ...
                c2.Connection = conn;
                c2.CommandText = "insert into  user_toy values(:id , :serial)";
                ...
                md.Connection = conn;
                md.CommandText = "select serial_number , amount  from electronic where t_name = :name";
                ...
                if (dr1.Read())
                {
                    ...
                    c1.Connection = conn;
                    c1.CommandText = "update  toy set amount = :neam  where serial_number = :ss";
