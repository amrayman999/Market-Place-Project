...
{
    public partial class admin_toys : UserControl
    { 
        ...
        private void admin_toys_Load(object sender, EventArgs e)
        {
        ...
        {
            string cmdstr1 = "select * from toy";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "insert into toy values (:snum,:name,:type,:amount,:price,:ad_pass)";
