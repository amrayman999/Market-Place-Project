...
{
    public partial class admin_cleans : UserControl
    {
        ...
        private void admin_cleans_Load(object sender, EventArgs e)
        {
        ...
        {
            string cmdstr1 = "select * from clean";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "insert into clean values (:snum,:name,:type,:amount,:price,:ad_pass)";
