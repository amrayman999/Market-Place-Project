...
{
    public partial class admin_sports : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "insert into sport values (:snum,:name,:type,:amount,:price,:ad_pass)";
        ...
        {
            string cmdstr1 = "select * from sport";
