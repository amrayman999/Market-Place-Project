...
{
    public partial class admin_clothes : UserControl
    {
        ...
        public admin_clothes()
        {
            InitializeComponent();
        }

        private void admin_clothes_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "insert into cloth values (:snum,:name,:type,:amount,:price,:ad_pass)";
        ...
        {
            string cmdstr1 = "select * from cloth";
