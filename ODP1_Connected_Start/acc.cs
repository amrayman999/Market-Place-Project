...
namespace ODP1_Connected_Start
{
    public partial class acc : UserControl
    {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "select serial_number, acc_name, acc_type,amount,price from accessory  where acc_name =:name";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cd.Connection = conn;
            cd.CommandText = "select serial_number ,price from accessory  where acc_name = :name";
            ...
            if (dr2.Read())
            {
                ...
                c2.Connection = conn;
                c2.CommandText = "insert into  user_acc values(:id , :serial)";
                ...
                md.Connection = conn;
                md.CommandText = "select serial_number , amount  from accessory where acc_name = :name";
                ...
                if (dr1.Read())
                {
                    ...
                    c1.Connection = conn;
                    c1.CommandText = "update  accessory set amount = :neam  where serial_number = :ss";
