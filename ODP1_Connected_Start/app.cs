...
namespace ODP1_Connected_Start
{
    public partial class app : UserControl
    {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "select serial_number, app_name, app_type,amount,price from applience  where app_name =:name";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cd.Connection = conn;
            cd.CommandText = "select serial_number ,price from applience  where app_name = :name";
            ...
            if (dr2.Read())
            {
                ...
                c2.Connection = conn;
                c2.CommandText = "insert into  user_app values(:id , :serial)";
                ...
                md.Connection = conn;
                md.CommandText = "select serial_number , amount  from applience where app_name = :name";
                ...
                if (dr1.Read())
                {
                    ...
                    c1.Connection = conn;
                    c1.CommandText = "update  applience set amount = :neam  where serial_number = :ss";
